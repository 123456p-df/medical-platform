    ...
    <section class="main-column">
      <div class="card">
        <div class="card-header">
          <div>
            <h3>AI Finding Review</h3>
            <p class="muted">Confirm, modify, or dismiss each model-generated finding.</p>
          </div>
          <div class="review-summary">
            <span><Clock3 :size="14" /> {{ pendingCount }} pending</span>
            <span><CheckCircle2 :size="14" /> {{ confirmedCount }} confirmed</span>
          </div>
        </div>
        <div class="card-body stack">
          ...
          />
          <div v-if="!activeFindings.length" class="empty-state">
            No AI findings are available for this examination.
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="card review-guide">
        ...
        <div class="card-body">
          <div class="check-item">
            <CircleAlert :size="17" />
            <span>Confirm findings that match the imaging evidence.</span>
          </div>
          <div class="check-item">
            <CircleAlert :size="17" />
            <span>Modify any finding text before it reaches the final report.</span>
          </div>
          <div class="check-item">
            <CircleAlert :size="17" />
            <span>Dismiss findings that are not clinically relevant.</span>
          </div>
        </div>
      </div>
      <button
