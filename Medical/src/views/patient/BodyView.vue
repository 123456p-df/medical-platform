...
<template>
  <div class="page">
    <PageHeader title="My Body" subtitle="Explore your digital human and understand your body." />
    ...
    <div class="body-layout">
      <section class="body-viewer card">
        <div class="card-header">
          <div>
            <h3>Digital Human</h3>
            <p class="muted">Select an organ for more information.</p>
          </div>
        </div>
    ...
    <section v-if="selectedOrganId === 'lung'" class="lung-detail card">
      <div class="card-header">
        <div>
          ...
          <p class="muted">Your latest doctor-reviewed lung information.</p>
        </div>
        <span class="lung-chip"><Activity :size="14" /> Lung</span>
      </div>
      <div class="card-body lung-detail-grid">
        ...
        <div class="lung-report">
          <div class="trust-note">
            <ShieldCheck :size="17" />
            <span>Only doctor-reviewed information is shown.</span>
          </div>
          <ReportCard v-if="latestReviewedReport" :report="latestReviewedReport" patient-facing />
          <div v-else class="empty-state">Your lung report is being reviewed by your doctor.</div>
        </div>
      </div>
    </section>
    ...
    <section v-else class="organ-detail card">
      ...
      <span class="muted">The full organ module will be available in a future release.</span>
    </section>
  </div>
</template>
