      ...
      <article class="health-overview card">
        <div class="card-header">
          <div>
            ...
            <p class="muted">Your most recent doctor-reviewed examination.</p>
          </div>
        </div>
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header">
          <div>
            ...
            <p class="muted">Your latest reviewed final report.</p>
          </div>
          <CalendarDays :size="18" class="header-icon" />
        </div>
        <div class="card-body">
          <ReportCard v-if="latestReviewedReport" :report="latestReviewedReport" patient-facing />
          <div v-else class="empty-state">Your reviewed report will appear here.</div>
        </div>
      </div>
    </section>
  </div>
