...
from transformers import (AutoConfig, AutoModelForCausalLM, Qwen2Config,
                          Qwen2ForCausalLM, Qwen2Model, Qwen3Config, Qwen3ForCausalLM, Qwen3Model, Qwen3VLModel, Qwen3VLConfig,
                          Qwen2_5_VLModel, Qwen2_5_VLForConditionalGeneration, Qwen2ForCausalLM, Qwen2_5_VLConfig)
from transformers.generation.utils import GenerateOutput
from transformers.modeling_outputs import CausalLMOutputWithPast

from radsight.constants import IGNORE_INDEX
from .radsight_arch import RadSightMetaForCausalLM, RadSightMetaModel


class RadSightQwen3Config(Qwen3VLConfig):
    model_type = "radsight_qwen3"

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.model_type = "radsight_qwen3"

class RadSightQwen3Model(RadSightMetaModel, Qwen3VLModel):
    config_class = RadSightQwen3Config

    def __init__(self, config: RadSightQwen3Config):
        super(RadSightQwen3Model, self).__init__(config)


### LLM
class RadSightQwen3ForCausalLM(Qwen3ForCausalLM, RadSightMetaForCausalLM):
    config_class = RadSightQwen3Config

    def __init__(self, config, **kwargs):
        super(Qwen3ForCausalLM, self).__init__(config)
        self.model = RadSightQwen3Model(config)
...
AutoConfig.register("radsight_qwen3", RadSightQwen3Config)
AutoModelForCausalLM.register(RadSightQwen3Config, RadSightQwen3ForCausalLM)
