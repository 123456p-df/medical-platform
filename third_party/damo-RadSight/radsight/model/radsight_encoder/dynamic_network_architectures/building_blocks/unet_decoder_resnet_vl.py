...
class UNetDecoder(nn.Module):
    def __init__(self,
        ...
        transpconvs = []
        seg_layers = []
        encoder_outchannels = [64, 128, 256, 512]
        up_channels = [256, 128, 64, 32]
        for s in range(n_stages_encoder):
            input_features_below = encoder_outchannels[-(s+1)]
            input_features_skip = up_channels[s]
            ...
            if s == 3:
                ...
                2, conv_op, 96, input_features_skip,
                3, 1,
                conv_bias,
                norm_op,
                norm_op_kwargs,
                ...
                stages.append(StackedConvBlocks(
                    2, conv_op, 2 * input_features_skip, input_features_skip,
                    3, 1,
                    conv_bias,
                    norm_op,
                    norm_op_kwargs,
