...
# Log Arguments
export WANDB_PROJECT=radsight_qwen3_vl_4b
RUN_NAME=stage_1_vison_projector_alignment
OUTP_DIR=output
...
torchrun --nnodes $WORLD_SIZE \
    ...
    --pretrain_vision_model ${PRETRAIN_3D:-"path/to/3d_encoder.pth"} \
    --pretrain_vision_model_2d ${PRETRAIN_2D:-"DAMO-NLP-SG/VL3-SigLIP-NaViT"} \
    --data_path ${DATA_PATH:-"path/to/stage1_train_data.json"} \
    --image_merge_size 1 \
    --video_merge_size 2 \
    ...
    --vision_encoder_3d_lr 1e-5 \
    --mm_projector_3d_lr 1e-3 \
    --weight_decay 0. \
    --warmup_ratio 0.03 \
