...
RUN_NAME=stage_2_vison_projector_llm_feature_detection
OUTP_DIR=output
...
torchrun --nnodes $WORLD_SIZE \
    ...
    --model_path ${MODEL_PATH:-"output/stage1/checkpoint"} \
    ...
    --data_path ${DATA_PATH:-"path/to/stage2_train_data.json"} \
    --image_merge_size 1 \
    --video_merge_size 2 \
