...
const doctorNav = computed(() => [
  ...
  { label: 'Reports', to: primaryPatientId.value ? `/doctor/patients/${primaryPatientId.value}/report` : '/doctor/patients', icon: FileText },
  { label: 'Medical Records', to: primaryPatientId.value ? `/doctor/patients/${primaryPatientId.value}` : '/doctor/patients', icon: ClipboardList },
  { label: 'Digital Human', to: primaryPatientId.value ? `/doctor/patients/${primaryPatientId.value}/3d` : '/doctor/patients', icon: Box },
])
